...
export default () => {
	...
	return (
		...
		>
			...
			/>
			<MainStack.Screen name="New" component={EmptyComponent}
				options={() => ({
			...
			/>
			<MainStack.Screen name="Plan" component={EmptyComponent}
				options={{
					tabBarIcon: ({ color, size, }) => (
			...
			/>
			<MainStack.Screen name="Settings" component={EmptyComponent}
				options={{
					tabBarIcon: ({ color, size, }) => (
